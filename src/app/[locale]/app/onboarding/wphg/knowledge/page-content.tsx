...
import WphgKnowledgeForm from './wphg-knowledge-form'

export default async function WphgKnowledgePageContent() {
  ...
  return (
    <WphgKnowledgeForm initialKnowledge={user.experience?.knowledge ?? null} />
  )
}
